...
const (
	RoleService_Get_FullMethodName            = "/kacho.cloud.iam.v1.RoleService/Get"
	RoleService_List_FullMethodName           = "/kacho.cloud.iam.v1.RoleService/List"
	RoleService_Create_FullMethodName         = "/kacho.cloud.iam.v1.RoleService/Create"
	RoleService_Update_FullMethodName         = "/kacho.cloud.iam.v1.RoleService/Update"
	RoleService_Delete_FullMethodName         = "/kacho.cloud.iam.v1.RoleService/Delete"
	RoleService_ListOperations_FullMethodName = "/kacho.cloud.iam.v1.RoleService/ListOperations"
)
...
type RoleServiceClient interface {
	...
	ListOperations(ctx context.Context, in *ListRoleOperationsRequest, opts ...grpc.CallOption) (*ListRoleOperationsResponse, error)
}
...
func (c *roleServiceClient) ListOperations(ctx context.Context, in *ListRoleOperationsRequest, opts ...grpc.CallOption) (*ListRoleOperationsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListRoleOperationsResponse)
	err := c.cc.Invoke(ctx, RoleService_ListOperations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RoleServiceServer interface {
	...
	// Lists operations for the specified role.
	ListOperations(context.Context, *ListRoleOperationsRequest) (*ListRoleOperationsResponse, error)
...
func (UnimplementedRoleServiceServer) ListOperations(context.Context, *ListRoleOperationsRequest) (*ListRoleOperationsResponse, error) {
...
func _RoleService_ListOperations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRoleOperationsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoleServiceServer).ListOperations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoleService_ListOperations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).ListOperations(ctx, req.(*ListRoleOperationsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kacho.cloud.iam.v1.RoleService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RoleService_ListOperations_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "kacho/cloud/iam/v1/role_service.proto",
}
